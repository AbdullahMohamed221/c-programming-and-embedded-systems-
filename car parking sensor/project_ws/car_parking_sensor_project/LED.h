 ...
 * */
#define LED_1_PORT_ID PORTC_ID
#define LED_1_PIN_ID PIN0_ID

#define LED_2_PORT_ID PORTC_ID
#define LED_2_PIN_ID PIN1_ID

#define LED_3_PORT_ID PORTC_ID
#define LED_3_PIN_ID PIN2_ID
/*ID for each lead
 * */
typedef enum{
	red=1,green,blue
