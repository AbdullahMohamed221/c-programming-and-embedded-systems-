...
/*if the lcd is 4 bit mode*/
#if (LCD_MODE==4)
#define LCD_D4_PIN_ID				   PIN3_ID
#define LCD_D5_PIN_ID				   PIN4_ID
#define LCD_D6_PIN_ID				   PIN5_ID
#define LCD_D7_PIN_ID				   PIN6_ID
#endif
/*imp commands of the lcd*/
